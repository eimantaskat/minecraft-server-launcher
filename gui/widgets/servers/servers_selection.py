...
class ServerSelection(QWidget):
    def __init__(self, servers, thread_handler, start_function, parent=None):
        ...
        self.start_button.clicked.connect(lambda: self.start_function(self.thread_handler, self.servers, self.server_select.currentIndex()))
